  ...
  class HttpResponse
    ...
    def getCookies(headers)
      ...
      headers.each { |k, v|
        ...
        # attribute-value pairs. The cookieValue can be optionally enclosed in
        # double quotes. Neither cookieName nor cookieValue can contain double
        # quotes, semicolons, or equal signs.
        match = /^([^=]*)=([^;]*)(|;.*)$/.match(v)
